  ...
  return (
    <div className="card">
      ...
      <p>
        ...
        blanditiis exercitationem placeat autem ullam ea doloremque, deserunt
        dignissimos laudantium! Dolor, magni? Recusandae eius, cumque voluptatum
        totam quo neque itaque ipsa, blanditiis enim vitae quia veritatis
        tempore magni error ratione!
      </p>
    </div>
  );
};
